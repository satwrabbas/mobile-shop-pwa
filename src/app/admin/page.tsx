  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-3xl p-6 text-white shadow-sm relative overflow-hidden">
          <div className="relative z-10">
            ...
            <h3 className="text-4xl font-bold">
              {stats?.totalSales} <span className="text-xl">$</span>
            </h3>
          </div>
        ...
        <Link
          href="/admin/orders"
          className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow group flex flex-col justify-between"
        >
